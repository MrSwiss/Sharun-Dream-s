...
void S_LOAD_CLIENT_USER_SETTING_New(player_t *);

void C_SAVE_CLIENT_USER_SETTING_f(player_t *player)
{
	...
	sprintf(FName, "%s/USER_SETTING/%i", Cfg_Server_DirSave, player->Charcter_Id);
	...
	S_LOAD_CLIENT_USER_SETTING_f(player);
//	USER_SETTING_Saved(player, S_LOAD_CLIENT_USER_SETTING);
